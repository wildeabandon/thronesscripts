...
\THEON: \sd{To \DAGMER} Right, get the horses and the hounds.
...
\ti{\ALTON ~is talking to \ROBB. \KARSTARK ~is watching.}
...
\ti{Dogs are barking. \THEON, \LUWIN, \DAGMER, and \SOLDIER ~are hunting \BRAN ~and \RICKON.}
...
\DAGMER: We've circled this farmhouse twice. There's no sign of them. \sd{exit.}
...
\THEON: \sd{To \LUWIN} Go back to Winterfell. \sd{To \SOLDIER.} Take him back.
...
\YGRITTE: \sd{Indicating her cunt.} Oh, it's nice and wet and warm.
...
\ti{\XARO ~is seated on a thronelike chair. The rest of the Thirteen (\SILKKING, \SPICEKING ~and \PYAT) are seated before him in a horseshoe. \DAENERYS ~stands by his side. \JORAH ~is behind them.}
...
\sd{An Undying \ASSASSIN ~slits the throats of \SILKKING ~and \SPICEKING. \DAENERYS ~runs back toward \JORAH, but wherever she runs, \PYAT ~is still there.}
