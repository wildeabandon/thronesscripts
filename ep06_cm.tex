...
\ti{\NED ~is lying on a bed. He wakes, and lifts his head to see \CERSEI ~and \ROBERT ~in front of him.}
...
\ROBERT: Piss on that. Send a raven. I want you to stay. I'm the King. I get what I want$\ldots$ I never loved my brothers. A sad thing for a man to admit, but it's true. You were the brother I chose. We'll talk when I return from the hunt. \sd{He throws the Hand's badge to him}
...
\ti{She takes the egg from \DAENERYS ~and throws it to the floor. She
turns \DAENERYS' hands to reveal her palms, unburnt. She looks at her,
unbelieving. \DAENERYS ~turns \IRRI's hands to reveal her reddened palms.}
...
\ti{Exit \ROBB ~and \THEON, re-enter \BRAN ~riding Dancer, slowly, deeper in the woods. He hears a sound and turns his head looking for what it is. \OSHA ~moves behind some shrubs, not far from him. He turns his head again, trying to spot something. She comes out from behind him, with two \textbf{WILDLINGS}. They approach him.}
...
\ti{\WILDLINGb moves \BRAN's cloak to reveal straps on his leg.}
...
\ti{Enter \ROBB ~behind them, holding a sword.}

\ROBB: Drop the knife. Let him go and I'll let you live. 

\ti{They fight. \ROBB ~kills \textbf{WILDLING 2} and and knocks \OSHA ~to the ground, but \WILDLINGa ~manages to grab \BRAN, and holds a knife to his throat.}
...
\ti{\ROBB ~and \WILDLINGa ~stare at each other. \ROBB ~slowly places the blade on the ground.}
...
\VISERYS: She'll never keep it down. \sd{Indicating the priestess} Tell me what she's saying. 
...
\ti{\VISERYS ~opens the chest of dragon eggs. Kneeling down, he heaves a sigh, then puts one inside a bag. As he reaches for the second, \JORAH ~enters the tent. \VISERYS ~stands up, a quarter of his sword unsheathed, and turns.}
...
\ti{\BRONN ~continued to dodge and weave, before managing to stab \VARDIS in the back. Mortally wounded, \VARDIS falls to the ground. \BRONN ~finishes him off, and throws him out of the Moon Door.}
...
\TYRION: A Lannister always pays his debts. \sd{exit, followed by \BRONN.}
...
\ti{A horse-drawn cart passes some people going the other way. \ROS ~sits at the back of the cart with some turnips beside her. \THEON ~comes up from behind riding a horse.}
...
\ti{\DAENERYS, \DROGO, \QOTHO, \JORAH, \textbf{RAKHARO}, and \IRRI
~are eating, drinking and laughing together. \VISERYS ~enters,
stumbling, drunk. }
...
\ti{\VISERYS ~draws his sword. \JORAH ~takes a step towards him and \VISERYS ~points his blade at his face.}
