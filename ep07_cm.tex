...
\ti{\JAIME ~enters the tent of \TYWIN. Tywin is (optionally) butchering a deer.} 

\JAIME: \sd{Starts reading from a letter.} Summoned to court to answer for the crimes of your bannerman Gregor Clegane, the Mountain $\ldots$ Uh, arrive within the fortnight or be branded an enemy of the Crown. Poor Ned Stark $\ldots$ Brave man, terrible judgment. 
...
\JAIME: I didn't realise you placed such a high value on my brother's life. 
...
\ti{\NED ~is sitting. \CERSEI ~approaches him. He needs a stick to stand.}
...
\NED: \sd{Indicating the bruises on her face.} Has he done this before? 
...
\THEON: \sd{Suddenly solicitous.} Do you want to lose that chain? \sd{Takes hold of her chin, moves their faces close.}
...
\WINESELLER: \sd{Kneeling.} Princess. 
...
\WINESELLER: As the princess commands. \sd{He pours a glass and hands it to Jorah.} Sweet, isn't it? Can you smell the fruit, Ser? Taste it, My Lord. Tell me that that is not the finest wine that has ever touched your tongue. 
...
\ti{He continues speaking, but the camera has moved away.}
...
\JEOR: As you wish, lad. You've all been assigned an order, according to our needs and your strengths. Halder to the builders. Pyp to the stewards. Toad to the builders. Grenn to the Rangers. Samwell to the stewards. Matthar to the Rangers. Dareon to the stewards. Balian to the Rangers. Rast to the Rangers. Jon to the stewards. \sd{Quieter, as the focus switches to JON's reaction.} Rancer to the builders. Echiel to the builders. Gordo to the stewards. Niko to the Rangers. Escan to the Rangers. Vorkoy to the builders. Joby to the stables. Mink to the kitchens. Allo to the builders. Nelugo to the Rangers. May all the Gods preserve you. 
...
\JON: \sd{Suppressed anger.} Will I serve the Lord Commander's meals and fetch hot water for his bath?
...
\JON: \sd{Angrily.} Do you take me for a servant? 
...
\ti{\JON ~storms off. \SAM ~goes after him.}
...
\ti{\RENLY ~enters to \NED ~and his \BANNERMAN.}

\RENLY: Lord Stark, a moment. Alone if you will. \sd{Exit \BANNERMAN.} He named you Protector of the Realm. 
...
\LITTLEFINGER: \sd{Bowing.} My Lord Protector. 
...
\ti{\DROGO ~enters. He approaches the \WINESELLER ~and looms threateningly, but then turns away without touching him and approaches \DAENERYS.}
...
\ti{His horsemen (i.e. all of us) begin to cheer as he goes on.}
...
\ti{\NED ~is walking with his \BANNERMAN. He moves directly between the next three scenes.}
...
\ti{The group makes its way to $\ldots$}
...
\PAGE: \sd{Announcing.} All hail his Grace, Joffrey of Houses Baratheon and Lannister, the first of his name, King of the Andals and the First Men, Lord of the Seven Kingdoms and Protector of the Realm. 
...
\CERSEI: \sd{She tears the paper.} A piece of paper? 
...
\NED: \sd{To the Goldcloaks.} Ser Barristan is a good man, a loyal man. Do him no harm. 
