...
\ti{Enter a \PROTESTER. \TYRION ~and \BRONN ~watch and listen.}
...
\ti{\TYWIN ~is chairing a council of war, including \AMORY ~and \REGINALD. \ARYA ~is listening while cleaning cups.}
...
\ti{\DAENERYS ~and \DOREAH ~are playing with Drogon. In the background, \IRRI ~is sorting out some clothes. DANAERYS gives Drogon a little bit of meat.}
...
\ti{Guests mingle. \DAENERYS ~is talking to a \QARTHEENWOMAN}
...
\ti{\XARO ~leads \DAENERYS ~off. Enter \QUAITHE, who is fully masked, to \JORAH.}
...
\ti{\QUAITHE ~turns and goes. Then so do the rest.}
...
\ti{\BRAN ~is giving an audience. \LUWIN ~attends him on his left. On his right, \RICKON ~is bored and chopping at something.}
...
\ti{\DAENERYS ~and \XARO ~are walking a corridor}
...
\XARO: \ti{Laughing.} You want to conquer the Seven Kingdoms for the Dothraki? 
