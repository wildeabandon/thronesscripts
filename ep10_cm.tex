...
\ti{Continuing directly from the previous scene.} 
...
\GENDRY: Oh, you like picking on the little ones, do you? You know, I've been hammering an anvil these past 10 years. When I hit that steel, it sings. Are you gonna sing when I hit you? \sd{\HOTPIE ~and \LOMMY ~make themselves scarce.  \GENDRY ~takes a closer look at Needle.} This is castle-forged steel. Where'd you steal it? 
...
\ti{\textbf{SHAGGYDOG}, Rickon's direwolf jumps out at them growling.}
...
\ti{Enter \CATELYN ~to \ROBB, who is hacking at a tree.}
...
\ti{\ILYNPAYNE ~heats his knife in a fire, then goes to carry out the order.}
...
\ti{\ROBB ~is speaking with \GLOVER, \UMBER, \BRACKEN, and \THEON. Other bannermen look on.} 
...
knee to \sd{kneels, draws his sword} the King in the North! 

\BRACKEN: \sd{also kneeling, drawing his sword} I'll have peace on those terms. They can keep their Red Castle and their Iron Chair too. The King in the North! 
...
\ti{\JAIME ~is chained to the wall and watched by \GUARD ~as \CATELYN ~enters.} 
...
\ti{\CERSEI ~and \LANCEL ~are scantily clad.} 
...
\ti{\TYWIN, \KEVAN, \TYRION, and first and second \textbf{LANNISTERS} are planning.} 
...
\ti{\DAENERYS ~wakes, with \JORAH ~beside her.  \MIRRI ~is also in the tent.} 
...
\ti{They go over to \DROGO, who lies propped against a rock, seemingly
awake but unaware.}
...
woman. Go. \sd{to \MIRRI} You knew what I was buying and you knew the price. 
...
\DAENERYS: \sd{to \DROGO} Affin shekh yola she jimma ma drivoe she titha$\ldots$ Arrek yer ajadi save, shekh ma shieraki anni. [When the star rises in the west and sets in the east$\ldots$ Then you will come back to me, my sun and stars.]
...
\ti{\JON ~is leaving.  \SAM ~tries to stop him.} 
...
\ti{Exit \JON, knocking \SAM ~out of his way.}

\scene

\textit{TYRION'S TENT}

\ti{\TYRION ~and \SHAE ~are talking.} 
...
\ti{\SAM, \GRENN, and \PYP ~chase \JON ~through the woods, until \SAM ~rides into an overhanging branch, and falls from his horse.  \GRENN ~and \PYP ~stop, and then \textbf{GHOST} runs back towards them.} 

\JON: Ghost? \sd{He follows \textbf{GHOST} back to the others.}
...
\ti{\PYCELLE ~and \ROS ~are dressing.} 
...
\ti{\LITTLEFINGER ~is looking at the throne, when \VARYS ~enters.} 
...
\ti{\JON ~and \JEOR ~are in \JEOR's chambers.} 
...
\ti{A great funeral pyre has been prepared for \DROGO. \DAENERYS ~stands with \JORAH ~and what remains of her Khalasar. \MIRRI ~is bound beside her.} 
...
\ti{\MIRRI ~begins chanting as the pyre is lit, but soon enough the chants turn to screams. \DAENERYS ~enters the flames of the pyre, carrying the dragon eggs. The next morning the pyre is burned to ash, but \DAENERYS ~remains, naked, unburned, with her three dragons.}
