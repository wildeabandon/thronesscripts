...
\ti{\SAM, \GRENN, and \PYP ~chase \JON ~through the woods, until \SAM ~rides into an overhanging branch, and falls from his horse.  \GRENN ~and \PYP ~stop, and then GHOST runs back towards them.} 
