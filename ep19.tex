...
\SHAE: It is now \sd{she straddles him}. 
...
\PYCELLE: Yes \sd{hands her a small bottle}.
...
\textbf{BRONN/LANNISTERS}: \sd{Singing, a little drunkenly} $\ldots$and so he spoke that Lord of Castamere but now the rains weep o'er his halls  with no one there to hear yes, now the rains weep o'er his halls and not a soul to hear. 
...
\BRONN: Thank you very much. \sd{Removes her clothes during the next
bit of dialogue --- \textbf{WHORE} is naked by the ``Third time'' remark below}
...
a scrap with a few older boys. They won. Third time$\ldots$ \sd{eyeing
her up} Eh, you don't want to know about the third time. 
...
\ti{\BRONN ~steps towards the \HOUND, covertly reaching for a
knife. They stare each other down.}
...
\ti{Enter \SANSA ~\& \SHAE; also \JOFFREY ~at the other end of the hall}
...
\TYRION: \ti{(to \SHAE)} Stay safe, My Lady. 

\SHAE: And you, my lion. 

\JOFFREY: Your king rides forth to battle. You should see him off with
a kiss. My new blade \sd{unsheathes it}. Hearteater I've named
it. Kiss it \sd{\SANSA ~does so}. You'll kiss it again when I return and
...
\sd{to \SGNS} Pour Lady Sansa some wine. 
...
stables as a warning \sd{\textbf{SER MANDON} bows and exits, with \SERI}.
...
\ti{In one corner of the stage, \MATTHOS ~and \DAVOS ~aboard Stannis'
fleet.  On the ramparts are \TYRION, \JOFFREY,
and \SERGEANT. Elsewhere, on a cliff-top overlooking the bay, is \BRONN.}

\JOFFREY: There they are. 

\TYRION: Archers to their marks. 

\SERGEANT: Archers, to your marks! \sd{after a brief pause} 
Archers! 
Nock your arrows! 
...
\DAVOS: \sd{with a pause after each instruction whilst it is carried
out} Archers, stand to! 
Man the below! 
Nock! 
Draw! 
Hold. 
\sd{to himself} There's no one on board. 
...
\ti{\TYRION ~gives the signal with a torch.}\\
\ti{\BRONN, seeing this, lights an arrow, shoots it at the wildfire.}
...
\ti{Everyone is shocked by what they see, excepting \JOFFREY, who
smirks}\\
\ti{\DAVOS ~\& \MATTHOS ~are both knocked down by the blast, their
fate uncertain.}
...
\CAPTAIN: We're too far from the gates. 
The fire, their archers $\ldots$ hundreds will die. 

\STANNIS: Thousands. \sd{turns, addressing the men at arms in his ship}
...
\sd{to \SGNS} One for her. \sd{\SGNS ~pours a glass, gives it to \CERSEI} 
Here. \sd{giving the glass to \SANSA}
Sit. 
Drink. \sd{\SANSA ~takes a little sip}
Not like that. Drink, girl. \sd{\SANSA ~does so.}
...
manages to touch solid ground \sd{\HOUND ~starts to leave, going
towards \SERGEANT ~\& \LANCEL}.
Pod, run to the King's gate. 
Bring any men guarding it here now. 

\PODRICK: Yes, My Lord \sd{exit}.

\HOUND: Let's go. Stannis is sending us fresh meat. \sd{slaps \LANCEL
~on the chest} You too! \sd{to \SERGEANT}
Any of these flaming fucking arrows come near me, I'll strangle you
with your own guts. \sd{exeunt \HOUND, \SERGEANT, \LANCEL}.
...
\CERSEI: And you will be Joffrey's. Enjoy \sd{noticing \SHAE} I don't
think I know this one \sd{they go over to \SHAE}. Pretty. \sd{\SHAE
~curtsies, badly} That's the worst curtsy I've ever seen. Here, it's
not difficult. I mastered it when I was four. Straighten your back and
bend. \sd{\SHAE ~curties, much better} Better. You learn fast. How
...
\HOUND: Someone bring me a drink. \sd{\textbf{SERVING BOY} hands him a
water-skin}. 
fuck the water. \sd{discarding the water} Bring me
wine. \sd{\textbf{SERVING BOY} gives him a bottle of wine. \HOUND
~drinks deeply}.
...
king on the field of battle. \sd{exit with \LANCEL}.

\ti{The fighting men [audience!] notice the king depart, begin to
mutter `where is the king?', mill around.}

\TYRION: \sd{Softly} I'll lead the attack. 
\sd{to the troops} I'll lead the attack! 
Pod, my helmet. 
...
\ti{\CERSEI ~hits \LANCEL ~where he is wounded}\\
\ti{\LANCEL ~cries in pain, and falls to the floor.}\\
\ti{Exit \CERSEI, dragging \TOMMEN ~with her.}

\SANSA: \sd{Addressing the other women} Don't be afraid. The queen has raised the drawbridge. 
...
\sd{starts to sing, and the other women join in, continuing for the
rest of the scene} Gentle mother, font of mercy, save our sons from war, we pray, gentle$\ldots$ 

\SHAE: \sd{to \SANSA} You must go. 
Run to your chamber and bar your door. 
Stannis won't hurt you. \sd{indicating \SERI} This one will. 
...
\SHAE: \sd{lifts her skirts, revealing a dagger strapped to her calf} No one is raping me. 
Go. Run. \sd{\SANSA ~runs out}

\scene

\textit{KINGS LANDING --- SANSA'S CHAMBER. \HOUND ~is concealed in a
corner.}\\
\ti{Enter \SANSA. She goes to her dolls, and picks one up.} 

\HOUND: The lady is starting to panic. 

\SANSA: \sd{startled} What are you doing here? 

\HOUND: Not here for long. 
I'm going. 
...
\TYRION: Attack! 
Roll it over! \sd{grabs torch, burns the rowboat/shield.}
...
\ti{\textbf{SER MANDON} approaches \TYRION, and suddenly swings at
him, wounding him in the face.}\\ 
\ti{As \textbf{SER MANDON} goes for the killing
blow, \PODRICK ~stabs him from behind with a spear, killing him.}\\
\ti{As \TYRION ~collapses, \PODRICK ~catches him}
...
I promise you.''\sd{raises the bottle to \TOMMEN's lips}

\ti{With a crash, the doors open. Enter \TYWIN, with a large body of
men.}\\
\ti{\CERSEI ~lets the bottle fall to the floor}
