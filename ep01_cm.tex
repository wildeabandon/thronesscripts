...
\ti{\WILL ~glares, but obeys. They all exit.}

\ti{Sometime later, the three Rangers return to the campsite, which is now completely cleared.}
...
\ti{As she murmurs to \SANSA ~about the embroidery, \ARYA ~struggles
with her needlework and listens to the laughter outside. \ARYA ~sneaks
out during the next few lines, finds a bow, and aims at the same
target as \BRAN.}
...
\ti{Enter \RODRIK ~to \NED ~and \CATELYN.}
...
\JON: You did well. \sd{Walks away.}

\ti{\ROBB ~turns and puts his arm around \BRAN ~and they go to their horses together. \NED ~approaches \BRAN.}
...
\ti{They start to leave, but come across a dead stag's head.}
...
\ti{A wild wedding celebration for \DROGO ~and \DAENERYS. Fighting and
fornication abounds. \DAENERYS ~looks stricken. \VISERYS ~and \ILLYRIO
~talk aside.}
...
\ti{Two \textbf{DOTHRAKI} fight to the death over a woman each is
trying to rape. \DROGO ~watches avidly. \textbf{DOTHRAKI 1}
kills \textbf{DOTHRAKI 2}, to cheers.}
