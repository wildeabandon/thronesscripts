...
\ti{\WILL ~is positioned on the tree limb that serves as a block. \NED ~draws ice from a scabbard held by \THEON.}
...
\ti{\DAENERYS ~is presented with a chest with three dragon eggs in it.}
...
\ti{\DROGO ~puts DANY on her horse and mounts his.}
...
\ti{The scene shifts to Winterfell.  \NED, \ROBERT, \TYRION ~and \HOUND ~are preparing to leave on a hunt.  \BRAN ~is playing.  \JAIME ~and \CERSEI ~are fucking, just offstage (upstairs).}
