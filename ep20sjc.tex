...
\STARKSOLDIERa: \sd{Offstage} I gave it to you to cut the rope, and now I don't have me dagger no more. So unless it got stuck in your ass on its way to your cunt, it stands to reason that it's gone $\ldots$ \sd{enter 3 \textbf{STARKSOLDIERS}} Whoa! What's your business here? 
...
\BRIENNE: If you've quite finished up $\ldots$ \sd{\textbf{STARKSOLDIERS} start laughing again} All right, we'll be going. \sd{\BRIENNE ~walks towards \JAIME ~} 
...
\STARKSOLDIERb: Wait. \sd{Walking up to \JAIME ~again} I do know you. \sd{To \textbf{STARKSOLDIERS}} That's Jaime Lannister. 
...
\ti{Beat. \BRIENNE ~pushes \JAIME ~away and \BRIENNE ~and \textbf{STARKSOLDIERS} fight. \JAIME ~watches from the side.   \STARKSOLDIERb ~is quickly killed. \STARKSOLDIERa is disarmed and knocked to the ground. He lies on the ground as \BRIENNE ~drops her knives, and pulls out her sword.}
...
\ti{\STANNIS ~and \MELISANDRE ~are at Dragonstone. They stand with their backs to each other.}
...
\ti{\THEON ~descends from the wall, joining the \IRONBORN ~in the courtyard. \DAGMER ~is behind him}
...
\THEON: \sd{Raising his sword} Aaaaaaah! 
...
\ti{Exit \IRONBORN ~, with two \IRONBORN ~dragging \THEON ~offstage, as \LUWIN ~falls to the ground}
...
\textit{QUARTH - OUTSIDE THE HOUSE OF THE UNDYING} 
...
\ti{\RICKON ~runs to \LUWIN ~, and \OSHA ~, \BRAN ~and \HODOR ~follow}
...
\ti{The WILDLINGS are walking across the mountains in single file, with \YGRITTE ~, \JON ~ AND \HALFHAND ~ among them. \JON ~ and \HALFHAND's hands are tied together with rope}
...
\textit{QUARTH - XARO'S CHAMBERS} 

\ti{\XARO ~is lying in his bed, with \DOREAH ~next to him. \KOVARRO ~gently eases his blade under \XARO�s ~necklace, and rips it off.} 

\XARO: \sd{Sitting up in alarm} What the $\ldots$ ? 

\ti{\DOREAH ~also sits up quickly. \DAENERYS ~, with her dragons, \JORAH ~ and the rest of the \textbf{DOTHRAKI} move forward until they are in sight}
...
\ti{Cut to: all have moved to XARO�S VAULT. \XARO ~and \DOREAH ~now have their hands bound. \KOVARRO ~uses the necklace to open the vault}

\DAENERYS: {Moving to the entrance of the vault, with a torch} Nothing. \sd{To \XARO ~} Thank you, Xaro Xhoan Daxos. Thank you for teaching me this lesson. 

\ti{\DAENERYS ~nods to \KOVARRO, who pushes \XARO ~forward. \DOREAH ~follows}

\XARO: I am King of Qarth. I can help you now, truly help you. {He is pushed to the entrance of the vault} We can take the Iron Throne. I'll bring you 1,000 ships. 
...
\ti{Cut to: \DAENERYS, \KOVARRO ~and \JORAH ~and the remaining \textbf{DOTHRAKI} are in \XARO's ~house, pulling out all of \XARO's ~things.}
...
\SAM: No, truly. The thing about her that I find so interesting \sd{\GRENN ~also kneels and roots around in snow} is that after all that Craster's done to her, she's still got hope that life might get better. 
