...
\ti{Enter the horses and the hounds. And \LUWIN, who with enthusiastic \THEON ~and \DAGMER ~reluctantly goes hunting tiny Starks.}
...
\HODOR: \ti{Laughing} Hodor.

\ti{JACK and BILLY are shouting playfully off-stage}
...
\YGRITTE: \ti{Mocking him.} Would you please shut up? You think you're better than me, crow. I'm a free woman-
...
\ti{From a high tower, \TYWIN ~looks down on some prisoners being brutally treated, and sniffs a dart. GREGOR is looking on.}
...
\ti{Exit GREGOR. \TYWIN ~looks at the food \ARYA ~has brought}
...
\ti{He turns and looks out of the window. During the next speech \ARYA ~handles the knife, thinking of killing him.}
...
\ti{\SANSA ~and SANDOR are walking in opposite directions. She speaks to him.}
...
\SANSA: \textbf{ckquote>Does it give you joy to scare people? <h4>HOUND</h4> <blockquote>No. It gives me joy to kill people.</blockq}: \ti{She fails to hide that she is scared and disgusted.}
...
\ti{She looks thoughtful and continues walking. Exit. He looks after her, perhaps with sympathy. He exits too.}
...
\ti{She starts walking, leading him again. Exeunt.}
...
\ti{Dogs are barking. \THEON, MAESTER \LUWIN ~and \DAGMER ~are hunting \BRAN ~and \RICKON.}
...
\THEON: \ti{To LUWIN} Go back to Winterfell.

\ti{To a SOLDIER.} Take him back.
...
\ti{He goes to touch her shoulder.}
...
\YGRITTE: \ti{She mimics his voice when she quotes him.}  And I thought that we were done, but he said, "Turn back around". I'll tell you what, Jon Snow, since it's going to be your word against mine, and since you can't talk about it without blushing, we may as well just.
...
\ti{\SANSA ~is having a nightmare about being attacked by the rioters. She wakes up and sees she's having her [first, presumably] period. She panics and tries to cut out the bloody part of the sheet with a fruit knife.}
...
\ti{The \HANDMAID ~nods and runs off. They all exit.}
...
\JAIME: \ti{Whispering.} You'll have to die.

\ti{\JAIME ~punches him so he falls, then clubs him to death with his chains.}

\ti{Enter TORRHEN to see what the fuss is about. \JAIME ~kills him too, strangling then snapping his neck. \JAIME ~steals his keys and runs.}
...
\ti{\XARO ~is seated on a thronelike chair. The rest of the Thirteen (SILK KING, \SPICEKING ~and \PYAT ~Pree) are seated before him in a horseshoe. \DAENERYS ~stands by his side. \JORAH ~is behind them.}
...
\ti{The UNDYING slit the throats of the rest of the Thirteen, other than \XARO ~and \PYAT. \DAENERYS ~runs back toward \JORAH, but wherever she runs, \PYAT ~is still there.}
...
\ti{\JAIME ~is pushed onto stage, covered in blood.}

\ti{Enter \KARSTARK, sword drawn.}
...
\ti{He is staring at \BRIENNE ~again.}
...
\CATELYN: \ti{To BRIENNE.} Your sword.
