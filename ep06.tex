...
\ROBERT: Piss on that. Send a raven. I want you to stay. I'm the King. I get what I want.... I never loved my brothers. A sad thing for a man to admit, but it's true. You were the brother I chose.  We'll talk when I return from the hunt. \sd{He throws the 'hand's badge' at him}
...
\WILDLINGa: \ti{(to BRAN)}  Shut up! to ROBB Drop the blade! 
...
\ti{He hits \TYRION, making him back away 'till his back is against the wall.}

\TYRION:  How would you like to be rich? 

\MORD: \ti{He hits \TYRION ~again}
...
\ti{\MORD ~searhes \TYRION's pockets}
...
\ti{\DAENERYS ~eats the last chunk of the heart as the \PRIESTESS ~continues to sing. She chokes and drops, one hand on the ground, the other on her mouth. She almost vomits. Then swallow the heart. \DROGO ~smiles at her.}
...
\ti{\DROGO ~walks to her and lifts her up, his arms wrapped around her waist, and carries her around the platform. the \CROWD ~moves forward, encircling \DAENERYS.}
...
\ti{\TYRION's hands are against the door}
...
\ti{Two KNIGHTS walk to a wheel and turn it. \ROBYN ~giggles as a round door on the ground opens}
...
\ROBYN: \ti{(cheerfully,to Lysa)} Is it over? 
...
\LITTLEFINGER: \ti{(still whispering to Ned)} That sounds like someone we know. The Mountain. 
...
\JOFFREY: My Lady. I fear I have behaved monstrously the past few weeks. \sd{he shows her a necklace he's holding} With your permission? \ti{She turns, smiling. \JOFFREY ~puts it around her neck.}
...
\VISERYS: \sd{spotting Dany} There she is. 
