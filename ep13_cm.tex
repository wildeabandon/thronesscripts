...
\ti{\JEOR ~is asleep. Enter \CRASTER, dragging \JON.}
...
\ti{Exeunt. Cut to \SAM ~packing crates and bags. \GILLY ~walks past.}
...
\ti{The fighting continues. \BRIENNE ~prevails, holding a knife to \LORAS'S throat.}
...
\ti{\BRIENNE ~does so. Crowd are like `OMG it's a lady!'. But quietly so.}
...
\ti{\TYRION ~is reading. \SHAE ~is pacing up and down.} 
...
\TYRION: I need you to deliver Lysa Arryn. I didn't need Janos Slynt. \sd{Pause. \LITTLEFINGER ~considers} It's settled, then? Good. Oh, and remember$\ldots$ the Queen mustn't know. 
...
\MARGAERY: You think so? I can't decide how I like it better. This way$\ldots$ \sd{She lets the bodice drop, revealing her breasts.} Or this way.
...
\ti{\THEON ~sighs and burns or tears the letter.}
...
\ti{During the next bit, \DROWNEDPRIEST ~pours seawater on \THEON's head three times.}
...
\sd{\PYCELLE ~is in bed with \DAISY. The door bursts open and in walk \TYRION, \TIMETT, and \BRONN. \DAISY ~covers herself up, runs and cowers in a corner. \BRONN ~drags \PYCELLE ~out of bed.} 
...
\sd{\TYRION ~and \VARYS ~are drinking together.} 
...
\LOMMY: \sd{has been wounded in the leg} Help! Help me! 
