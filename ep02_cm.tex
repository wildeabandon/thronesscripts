...
\ti{They arrive in the camp. \DAENERYS's hands are raw from the
reins. Her handmaidens \DOREAH ~\& \IRRI ~take her away, and \JORAH ~goes to speak to \VISERYS.}
...
\CERSEI: The children don't need to hear your filth. Come. \sd{Exit
with \TOMMEN ~\& \MYRCELLA.} 
...
\ti{\CERSEI ~enters to \CATELYN ~who starts to rise. \BRAN ~is unconscious.}
...
\ti{\JON ~and \TYRION ~are sitting around a fire on the way to the
wall. \TYRION ~looks up from his book.}
...
\ROBB: \sd{looking out} Fire. You stay here. I'll come back. 
...
\ti{\DAENERYS ~and her handmaidens \IRRI, \JHIQUI, and \DOREAH ~are in her tent.}
...
\ti{Freeze, then resume --- It's a little later. \DAENERYS ~is lying on her back, with \DOREAH ~straddling her.}
...
\ti{Freeze, then exit \DOREAH. A little later again. \DROGO ~enters and is about to push \DAENERYS ~down and take her from behind again.}
...
\SANSA: \sd{to her direwolf} Stay, Lady. 
...
\ti{\NED ~enters to \ROBERT, \CERSEI, \JOFFREY, \ARYA,
and \SANSA. \SOLDIERa is also in the room.}
