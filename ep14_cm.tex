...
\ti{\textbf{GREY WIND} leaps from the shadows and attacks \RENNICK, who screams.}
...
\ti{\TYRION ~offers his hand to \SANSA ~and helps her to her feet, then leads her up away from the throneroom, followed by \BRONN ~and speaking quietly to her once they are out of earshot..}
...
\ti{\HOUND ~is standing guard. Enter \JOFFREY.} 
...
\ti{\HOUND ~exits, and \JOFFREY ~goes inside, where \DAISY ~and \ROS ~are sitting on the bed, dressed sexily and giggling.}
...
\ti{\GENDRY, \ARYA ~and \HOTPIE ~are being driven along by \GUARD ~as part of a convoy of prisoners. They stop and stare at Harrenhal's burnt and forbidding exterior.}
...
\ti{\LITTLEFINGER ~leaves. \CATELYN ~weeps over the bones.}
...
\ti{\HOTPIE ~is staring at \MOUNTAIN.}
...
\MOUNTAIN: \sd{Pointing to \PRISONER.} You. 

\ti{\HOTPIE ~pisses himself. For our purposes, I would recommend some other expression of fear.}
...
\RENLY: \sd{To \STANNIS.} Can that truly be you? 
...
\ti{\DAENERYS ~and \JORAH ~are standing in front of the rest of their party, staring at a locked gate, guarded by the Unsullied.}
...
\SPICEKING: \sd{Interrupting.} Daenerys Stormborn of the House Targaryen. 
...
\SPICEKING: \sd{Correcting her pronounciation.} Qarth. 
...
\XARO: \sd{Stepping forward to interrupt.} Retreating in fear from a little girl is unbecoming of the greatest city that ever was or will be.
...
\ti{He draws his knife, and cuts his palm to seal the pledge.}
...
\POLLIVER: \sd{To \ARYA.} What are you looking at? Kneel! Kneel or I'll carve your lungs out, boy. 
...
\STANNIS: \sd{Interrupting.}  I want you to be a smuggler this time. 
